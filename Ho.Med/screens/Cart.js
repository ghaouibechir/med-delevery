...
import { SafeAreaView, StatusBar, View, BackHandler, Text, StyleSheet, ScrollView, FlatList, TouchableOpacity, TouchableWithoutFeedback, Modal, Image, Dimensions } from "react-native";
...
class Cart extends Component {
    ...
    addMoreItemsInfo() {
        return (
            <TouchableOpacity
                activeOpacity={0.9}
                onPress={() => this.props.navigation.push('OrderMedicines')}
    ...
    quantity({ number }) {
        return (
            <TouchableOpacity
                ...
                style={{
                    backgroundColor: this.state.currentQuantity == number ? '#E2E2E2' : Colors.whiteColor,
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <View style={{ width: width - 150.0, marginLeft: Sizes.fixPadding, }}>
                                        ...
                                        <TouchableOpacity
                                            activeOpacity={0.9}
                                            onPress={() => this.setState({ quantityDialog: true, currentItemId: item.id, currentQuantity: item.qty })}
